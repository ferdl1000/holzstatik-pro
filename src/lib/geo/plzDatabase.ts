...
export const PLZ_DATABASE: PlzEntry[] = [
  ...
  // === Bezirk Hartberg-Fürstenfeld (östliche Steiermark) ===
  { plz: '8181', city: 'Sankt Ruprecht an der Raab', state: 'Steiermark', lat: 47.17, lng: 15.61, elevation: 410, snowZone: '3', windZone: '2', terrain: 'II' },
  { plz: '8224', city: 'Kaindorf bei Hartberg',     state: 'Steiermark', lat: 47.27, lng: 15.97, elevation: 320, snowZone: '3', windZone: '2', terrain: 'II' },
  { plz: '8225', city: 'Pöllau',                    state: 'Steiermark', lat: 47.30, lng: 15.83, elevation: 420, snowZone: '3', windZone: '2', terrain: 'II' },
  { plz: '8240', city: 'Friedberg',                 state: 'Steiermark', lat: 47.43, lng: 16.10, elevation: 654, snowZone: '3', windZone: '2', terrain: 'II' },
  { plz: '8250', city: 'Vorau',                     state: 'Steiermark', lat: 47.40, lng: 15.88, elevation: 722, snowZone: '3', windZone: '2', terrain: 'II' },
  { plz: '8255', city: 'St. Jakob im Walde',        state: 'Steiermark', lat: 47.45, lng: 15.78, elevation: 1057, snowZone: '4', windZone: '2', terrain: 'I' },
  { plz: '8273', city: 'Ebersdorf bei Hartberg',    state: 'Steiermark', lat: 47.27, lng: 16.07, elevation: 305, snowZone: '3', windZone: '2', terrain: 'II' },
  { plz: '8274', city: 'Buch-St. Magdalena',        state: 'Steiermark', lat: 47.30, lng: 16.05, elevation: 320, snowZone: '3', windZone: '2', terrain: 'II' },
  { plz: '8280', city: 'Fürstenfeld',               state: 'Steiermark', lat: 47.05, lng: 16.08, elevation: 273, snowZone: '3', windZone: '2', terrain: 'II' },
  { plz: '8291', city: 'Burgau',                    state: 'Steiermark', lat: 47.18, lng: 16.07, elevation: 350, snowZone: '3', windZone: '2', terrain: 'II' },
  { plz: '8295', city: 'Sankt Johann in der Haide', state: 'Steiermark', lat: 47.30, lng: 16.05, elevation: 305, snowZone: '3', windZone: '2', terrain: 'II' },
  { plz: '8311', city: 'Markt Hartmannsdorf',       state: 'Steiermark', lat: 47.10, lng: 15.83, elevation: 365, snowZone: '3', windZone: '2', terrain: 'II' },
  { plz: '8330', city: 'Feldbach',                 state: 'Steiermark', lat: 46.9500, lng: 15.8833, elevation: 282, snowZone: '3', windZone: '2', terrain: 'II' },
  { plz: '8341', city: 'Paldau',                    state: 'Steiermark', lat: 46.96, lng: 15.84, elevation: 290, snowZone: '3', windZone: '2', terrain: 'II' },
  { plz: '8361', city: 'Fehring',                   state: 'Steiermark', lat: 46.95, lng: 16.00, elevation: 275, snowZone: '3', windZone: '2', terrain: 'II' },
